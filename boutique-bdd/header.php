        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse col-4" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item text-center"><a class="nav-link active" href="./index.php">Boutique</a>
                    </li>
                    <li class="nav-item text-center"><a class="nav-link" href="../catalogs/index.php">Catalogue</a></li>
                </ul>

                <div class="text-center col-4 logo">
                    <a class="navbar-brand" href="https://martinbaptiste.fr"><img src="img/me.png" alt="logo"></a>
                </div>
            </div>
        </div>
    </nav>